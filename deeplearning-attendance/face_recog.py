...
while True:
 # Grab a single frame of video
    ...
    if True in matches:
            ...
            #name_label = known_label[first_match_index:20]
            # Assign attendance
